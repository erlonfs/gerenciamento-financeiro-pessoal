...
CREATE TABLE COMP.Competencia(
	...
	TotalContasAPagar DECIMAL NOT NULL,
	TotalContasAReceber DECIMAL NOT NULL
)
GO
ALTER TABLE COMP.Competencia ADD CONSTRAINT PK_Competencia PRIMARY KEY (Id)
GO
ALTER TABLE COMP.Competencia ADD CONSTRAINT UC_Competencia_Mes_Ano UNIQUE(Mes, Ano);
GO
